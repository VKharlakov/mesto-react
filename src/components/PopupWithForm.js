...
function PopupWithForm(props) {
    return (
        ...
        <div className="popup__container">
          ...
          <form className="popup__form" id="edit-profile-form" name={props.name} noValidate>
            {props.children}
            <button className="popup__btn-submit" type="submit" aria-label="Сохранить">Сохранить</button>
          </form>
        </div>
      </div>
    )
